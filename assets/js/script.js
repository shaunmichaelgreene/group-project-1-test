...
var formSubmitHandler = function(event) {
    ...
    if (isNaN(zipInput)) { //NEED ERROR HANDLING TO DETECT NON-NUMERIC CHARACTERS IN THE INPUT, AND EXACTLY 5 CHARACTERS (string length, includes) REGEX //(^\d{5}$) - per Kevin - SEE ROBOT GLADIATORS
